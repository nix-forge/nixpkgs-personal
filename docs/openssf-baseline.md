...
version 2026.08.28 as its security policy reference. The policy covers package recipes, overlays, NUR metadata,
source updates, CI, and documentation.

## Current assessed status

The [current self-assessment](https://www.bestpractices.dev/en/projects/14639/baseline-2)
